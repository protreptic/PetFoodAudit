package org.javaprotrepticon.android.audit.fragment.base;
...
import org.javaprotrepticon.android.audit.activity.MainActivity;
...
public abstract class BaseEntityListFragment<T> extends Fragment implements SyncObserver, OnRefreshListener {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mRobotoCondensedLight = Fonts.get(getActivity()).getTypeface("Rotonda-Bold");
		mRobotoCondensedBold = Fonts.get(getActivity()).getTypeface("Rotonda-Regular");
